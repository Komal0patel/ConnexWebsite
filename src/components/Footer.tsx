const Footer = () => {
    return (
        <footer className="bg-[#3ac3d6] py-12 pb-40 border-t border-white/5 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-40">
                    ...
                    <div className="max-w-md space-y-12">
                        <div className="flex flex-col gap-2">
                            ...
                            <span className="text-[9px] text-white/50 font-sans tracking-[0.8em] font-medium uppercase transition-all">Architectural Light Systems</span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-24 lg:gap-40">
                        <div>
                            <p className="text-[12px] text-slate-900 font-black uppercase tracking-[0.4em] mb-12 shadow-sm">Dimensions</p>
                        ...
                        <div>
                            <p className="text-[12px] text-slate-900 font-black uppercase tracking-[0.4em] mb-12 shadow-sm">Collective</p>
                            <ul className="space-y-8">
                                {['LinkedIn', 'Behance', 'Instagram'].map(link => (
                                    <li key={link}>
                                        <a href="#" className="text-[13px] text-slate-900/60 hover:text-slate-900 uppercase tracking-[0.2em] font-black transition-all">
                                            {link}
                                        </a>
                                    </li>
                                ))}
