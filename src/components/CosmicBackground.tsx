    ...
    return (
        <div className="fixed inset-0 -z-50 bg-[#FDFDFA] overflow-hidden pointer-events-none">
            ...
            <div className="absolute inset-0 opacity-[0.03]"
                style={{
                    backgroundImage: 'linear-gradient(rgba(26, 60, 109, 0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(26, 60, 109, 0.1) 1px, transparent 1px)',
            ...
            <div className="absolute inset-0">
                <div className="absolute top-0 right-0 w-[60vw] h-[60vw] bg-[#1a3c6d]/[0.05] rounded-full blur-[12vw] -translate-y-1/2 translate-x-1/2" />
