...
const SuperHero = () => {
    return (
        <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden py-40">
            ...
            {/* 1. Subtle Background Geometry - Kept for texture */}
                ...
                <div className="max-w-4xl space-y-12">
                    <div className="space-y-6">
                        <motion.div
                            ...
                            className="flex items-center justify-center gap-4 text-white/40 font-mono text-[10px] uppercase font-bold tracking-[1em]"
                        >
                            <span className="text-white text-[10px] uppercase tracking-[0.5em] font-medium mix-blend-difference mb-8">
                                Connex Selection / 001
                            </span>
                        </motion.div>

                        <h1 className="flex flex-col text-[12vw] lg:text-[9vw] font-serif leading-[0.8] tracking-tighter uppercase text-white">
                            <motion.span
                    ...
                    >
                        ...
                        <div className="flex gap-20 pt-8 border-t border-white/5 w-full justify-center">
            ...
            <div className="absolute bottom-10 left-0 w-full px-12 flex justify-between items-end">
                <div className="flex items-center gap-10">
                    <span className="text-[8px] font-mono text-white/20 tracking-[0.5em] uppercase">SYSTEMS_ACTIVE / 2026</span>
                    <div className="w-20 h-px bg-white/10" />
                </div>
                <div className="text-right flex flex-col items-end gap-2">
                    <span className="text-[8px] font-mono text-white/40 block tracking-[0.8em]">PHASE_03_DEPLOYED</span>
